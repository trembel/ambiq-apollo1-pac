#[doc = "Reader of register INT1SET"]
pub type R = crate::R<u32, super::INT1SET>;
#[doc = "Writer for register INT1SET"]
pub type W = crate::W<u32, super::INT1SET>;
#[doc = "Register INT1SET `reset()`'s with value 0"]
impl crate::ResetValue for super::INT1SET {
    type Type = u32;
    #[inline(always)]
