#[doc = "Reader of register INT0SET"]
pub type R = crate::R<u32, super::INT0SET>;
#[doc = "Writer for register INT0SET"]
pub type W = crate::W<u32, super::INT0SET>;
#[doc = "Register INT0SET `reset()`'s with value 0"]
impl crate::ResetValue for super::INT0SET {
    type Type = u32;
    #[inline(always)]
