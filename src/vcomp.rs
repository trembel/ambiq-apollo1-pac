...
#[doc = "Status Register"]
pub mod stat;
#[doc = "Key Register for Powering Down the Voltage Comparator\n\nThis register you can [`read`](crate::generic::Reg::read), [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`write_with_zero`](crate::generic::Reg::write_with_zero), [`modify`](crate::generic::Reg::modify). See [API](https://docs.rs/svd2rust/#read--modify--write-api).\n\nFor information about available fields see [pwdkey](pwdkey) module"]
pub type PWDKEY = crate::Reg<u32, _PWDKEY>;
#[allow(missing_docs)]
#[doc(hidden)]
pub struct _PWDKEY;
#[doc = "`read()` method returns [pwdkey::R](pwdkey::R) reader structure"]
impl crate::Readable for PWDKEY {}
#[doc = "`write(|w| ..)` method takes [pwdkey::W](pwdkey::W) writer structure"]
impl crate::Writable for PWDKEY {}
#[doc = "Key Register for Powering Down the Voltage Comparator"]
pub mod pwdkey;
