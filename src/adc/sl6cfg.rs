#[doc = "Reader of register SL6CFG"]
pub type R = crate::R<u32, super::SL6CFG>;
#[doc = "Writer for register SL6CFG"]
pub type W = crate::W<u32, super::SL6CFG>;
#[doc = "Register SL6CFG `reset()`'s with value 0"]
impl crate::ResetValue for super::SL6CFG {
    type Type = u32;
    #[inline(always)]
...
#[doc = "Reader of field `ADSEL6`"]
pub type ADSEL6_R = crate::R<u8, ADSEL6_A>;
impl ADSEL6_R {
...
#[doc = "Write proxy for field `ADSEL6`"]
...
impl From<THSEL6_A> for u8 {
    #[inline(always)]
    fn from(variant: THSEL6_A) -> Self {
        variant as _
    }
}
#[doc = "Reader of field `THSEL6`"]
pub type THSEL6_R = crate::R<u8, THSEL6_A>;
impl THSEL6_R {
    #[doc = r"Get enumerated values variant"]
    #[inline(always)]
    pub fn variant(&self) -> THSEL6_A {
        match self.bits {
            0 => THSEL6_A::_1_ADC_CLK,
            1 => THSEL6_A::_2_ADC_CLKS,
            2 => THSEL6_A::_4_ADC_CLKS,
            3 => THSEL6_A::_8_ADC_CLKS,
            4 => THSEL6_A::_16_ADC_CLKS,
            5 => THSEL6_A::_32_ADC_CLKS,
            6 => THSEL6_A::_64_ADC_CLKS,
            7 => THSEL6_A::_128_ADC_CLKS,
            _ => unreachable!(),
        }
    }
...
pub type CHSEL6_R = crate::R<u8, CHSEL6_A>;
impl CHSEL6_R {
    #[doc = r"Get enumerated values variant"]
    #[inline(always)]
    pub fn variant(&self) -> crate::Variant<u8, CHSEL6_A> {
        use crate::Variant::*;
        match self.bits {
            0 => Val(CHSEL6_A::EXT0),
            1 => Val(CHSEL6_A::EXT1),
...
#[doc = "Reader of field `WCEN6`"]
pub type WCEN6_R = crate::R<bool, WCEN6_A>;
impl WCEN6_R {
    #[doc = r"Get enumerated values variant"]
    #[inline(always)]
    pub fn variant(&self) -> crate::Variant<bool, WCEN6_A> {
        use crate::Variant::*;
        match self.bits {
            true => Val(WCEN6_A::WCEN),
            i => Res(i),
        }
    }
...
#[doc = "Write proxy for field `WCEN6`"]
...
#[doc = "Reader of field `SLEN6`"]
pub type SLEN6_R = crate::R<bool, SLEN6_A>;
impl SLEN6_R {
    #[doc = r"Get enumerated values variant"]
    #[inline(always)]
    pub fn variant(&self) -> crate::Variant<bool, SLEN6_A> {
        use crate::Variant::*;
        match self.bits {
            true => Val(SLEN6_A::SLEN),
            i => Res(i),
        }
    }
...
#[doc = "Write proxy for field `SLEN6`"]
...
impl R {
    ...
    #[inline(always)]
    pub fn thsel6(&self) -> THSEL6_R {
        THSEL6_R::new(((self.bits >> 16) & 0x07) as u8)
    }
