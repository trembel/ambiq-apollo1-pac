...
#[doc = "Select the track and hold delay for this slot. NOTE: The track and hold delay must be less than 50us for correct operation. When the ADC is configured to use the 1.5 Mhz clock, the track and hold delay cannot exceed 64 clocks.\n\nValue on reset: 0"]
#[derive(Clone, Copy, Debug, PartialEq)]
#[repr(u8)]
pub enum THSEL1_A {
...
impl From<THSEL1_A> for u8 {
    #[inline(always)]
    fn from(variant: THSEL1_A) -> Self {
        variant as _
    }
}
#[doc = "Reader of field `THSEL1`"]
pub type THSEL1_R = crate::R<u8, THSEL1_A>;
impl THSEL1_R {
    #[doc = r"Get enumerated values variant"]
    #[inline(always)]
    pub fn variant(&self) -> THSEL1_A {
        match self.bits {
            0 => THSEL1_A::_1_ADC_CLK,
            1 => THSEL1_A::_2_ADC_CLKS,
            2 => THSEL1_A::_4_ADC_CLKS,
            3 => THSEL1_A::_8_ADC_CLKS,
            4 => THSEL1_A::_16_ADC_CLKS,
            5 => THSEL1_A::_32_ADC_CLKS,
            6 => THSEL1_A::_64_ADC_CLKS,
            7 => THSEL1_A::_128_ADC_CLKS,
            _ => unreachable!(),
        }
    }
...
impl R {
    ...
    #[doc = "Bits 16:18 - Select the track and hold delay for this slot. NOTE: The track and hold delay must be less than 50us for correct operation. When the ADC is configured to use the 1.5 Mhz clock, the track and hold delay cannot exceed 64 clocks."]
    #[inline(always)]
    pub fn thsel1(&self) -> THSEL1_R {
        THSEL1_R::new(((self.bits >> 16) & 0x07) as u8)
    }
