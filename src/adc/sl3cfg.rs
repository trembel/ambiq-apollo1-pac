...
impl From<THSEL3_A> for u8 {
    #[inline(always)]
    fn from(variant: THSEL3_A) -> Self {
        variant as _
    }
}
#[doc = "Reader of field `THSEL3`"]
pub type THSEL3_R = crate::R<u8, THSEL3_A>;
impl THSEL3_R {
    #[doc = r"Get enumerated values variant"]
    #[inline(always)]
    pub fn variant(&self) -> THSEL3_A {
        match self.bits {
            0 => THSEL3_A::_1_ADC_CLK,
            1 => THSEL3_A::_2_ADC_CLKS,
            2 => THSEL3_A::_4_ADC_CLKS,
            3 => THSEL3_A::_8_ADC_CLKS,
            4 => THSEL3_A::_16_ADC_CLKS,
            5 => THSEL3_A::_32_ADC_CLKS,
            6 => THSEL3_A::_64_ADC_CLKS,
            7 => THSEL3_A::_128_ADC_CLKS,
            _ => unreachable!(),
        }
    }
...
impl R {
    ...
    #[inline(always)]
    pub fn thsel3(&self) -> THSEL3_R {
        THSEL3_R::new(((self.bits >> 16) & 0x07) as u8)
    }
