#[doc = "Reader of register REGACCINTEN"]
pub type R = crate::R<u32, super::REGACCINTEN>;
#[doc = "Writer for register REGACCINTEN"]
pub type W = crate::W<u32, super::REGACCINTEN>;
#[doc = "Register REGACCINTEN `reset()`'s with value 0"]
impl crate::ResetValue for super::REGACCINTEN {
    type Type = u32;
    #[inline(always)]
