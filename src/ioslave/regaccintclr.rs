#[doc = "Reader of register REGACCINTCLR"]
pub type R = crate::R<u32, super::REGACCINTCLR>;
#[doc = "Writer for register REGACCINTCLR"]
pub type W = crate::W<u32, super::REGACCINTCLR>;
#[doc = "Register REGACCINTCLR `reset()`'s with value 0"]
impl crate::ResetValue for super::REGACCINTCLR {
    type Type = u32;
    #[inline(always)]
