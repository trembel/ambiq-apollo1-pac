#[doc = "Reader of register DCODEFAULTADDR"]
pub type R = crate::R<u32, super::DCODEFAULTADDR>;
#[doc = "Writer for register DCODEFAULTADDR"]
pub type W = crate::W<u32, super::DCODEFAULTADDR>;
#[doc = "Register DCODEFAULTADDR `reset()`'s with value 0"]
impl crate::ResetValue for super::DCODEFAULTADDR {
    type Type = u32;
    #[inline(always)]
